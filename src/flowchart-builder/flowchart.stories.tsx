...
export const FlowchartPrimary: FC = () => {
  ...
  const onReady = (flowchart: FlowchartHandles) => {
    ...
    let links = JSON.parse(`[ { "from": 2, "to": 3, "type":"dashed","meta":{"ratioS":[0.7,0.9], "ratioD":[0.6,-1 ], "sideD":{"vertical":true, "firstSide":true}} }, { "from": 4, "to": 6 }, { "from": 5, "to": 6 }, { "from": 1, "to": 2 }, { "from": 3, "to": 4, "text": "Yes" }, { "from": 3, "to": 5, "text": "No" }, { "from": 5, "to": 5 } ]`);
